...
export default class Algomas extends React.Component {
    state = {
        open: false,
        ...
        Data:[
            ...
            {cols: 1,title:'Fruta',desc:'Preparada con yogurt y granola',img:'https://images.pexels.com/photos/1210534/pexels-photo-1210534.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260'},
    ...
    render() {
        ...
        return (
            <div>
                ...
                >
                    <DialogTitle id="scroll-dialog-title">Algo más</DialogTitle>
                    <DialogContent>
                        <GridList cellHeight={200} spacing={1} style={styles.gridList} cols={3}>
                            {Data.map(tile => (
